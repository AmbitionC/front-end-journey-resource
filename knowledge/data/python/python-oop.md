Python 是 AI/Agent 工程的首选语言，绝大多数主流框架——LangChain、LlamaIndex、AutoGen、CrewAI——都是纯 Python 实现。理解 Python 的数据类型和面向对象机制，不只是"写好代码"的基本功，更直接决定你能否读懂这些框架的源码、设计出可扩展的 Agent 系统。
